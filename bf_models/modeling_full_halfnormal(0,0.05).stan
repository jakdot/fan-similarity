...
parameters {
  vector<upper=0>[Kc] b;  // regression coefficients (should be negative, see below)
...
transformed parameters {
  ...
  r_2_1 = r_2[, 1];
  r_2_2 = r_2[, 2];
  lprior += normal_lpdf(b | 0, 0.05)
    - 1 * normal_lcdf(0 | 0, 0.05);  // Note: lcdf not lccdf because b should be negative, not positive
